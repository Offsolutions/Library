...
namespace LibraryManagement.Controllers
{
    public class AccountsController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "id,Name,Phone,Role,Username,Password")] Account account)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "id,Name,Phone,Role,Username,Password")] Account account)
        {
            if (ModelState.IsValid)
            {
